...
void WriteKernelInformation(int iTargetFd, int iTotalKernelSectorCount, int iKerne32lSectorCount);
...
int main(int argc, char* argv[])
{
	...
	{
		fprintf( stderr, "[ERROR] Dis.img open fail.\n");
		exit(-1);
	}
